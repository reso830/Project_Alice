...
describe('release metadata', () => {
  it('keeps the 2.0.0 release version in sync across package, app chrome, and docs', () => {
    expect(pkg.version).toBe('2.0.0');
    expect(APP_VERSION).toBe('v2.0.0');

    const lock = JSON.parse(read('package-lock.json'));
    expect(lock.version).toBe('2.0.0');
    expect(lock.packages['']?.version).toBe('2.0.0');

    expect(read('README.md')).toContain('Current version: **2.0.0**');
    expect(read('CHANGELOG.md')).toContain('## [2.0.0] — 2026-07-11');
    expect(read('CHANGELOG.md')).toContain('## [1.15.0] — 2026-07-11');
    ...
    expect(read('CHANGELOG.md')).toContain('## [1.12.10] — 2026-07-08');
    ...
    expect(read('CHANGELOG.md')).toContain('[Unreleased]: https://github.com/reso830/Project_Alice/compare/v2.0.0...HEAD');
    expect(read('CHANGELOG.md')).toContain('[2.0.0]: https://github.com/reso830/Project_Alice/compare/v1.15.0...v2.0.0');
    expect(read('CHANGELOG.md')).toContain('[1.15.0]: https://github.com/reso830/Project_Alice/compare/v1.14.0...v1.15.0');
    ...
    expect(read('CHANGELOG.md')).toContain('[1.12.10]: https://github.com/reso830/Project_Alice/compare/v1.12.9...v1.12.10');
