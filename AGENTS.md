...
Skills are defined in `.agents/skills/` and mirrored to `.Codex/skills/`. Run them in order:
...
Active worktrees live under `.Codex/worktrees/`. PowerShell setup scripts are in `.specify/scripts/powershell/`.
