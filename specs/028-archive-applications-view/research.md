...
- `tests/pages/Profile.test.js` (or `ProfileEdit.test.js` if profile suite is split) — `Archived applications · N →` link renders with the correct count, including `0`; clicking it navigates to `/?view=archived`.
