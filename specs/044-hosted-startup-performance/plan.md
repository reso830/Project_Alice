...
- `index.html` — inlined loader markup + critical CSS (scoped class names) + sigil `<svg>`; font strategy (WS5).
...
- `index.html` (inlined loader markup + critical CSS, scoped class names, + sigil `<svg>`; WS5 font strategy)
