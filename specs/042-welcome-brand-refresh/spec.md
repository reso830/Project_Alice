...
- **Q: Logo Usage Rules & Dimensions** $\rightarrow$ A:
  ...
  - **Welcome Page**: Displays the full-color sigil (`alice-sigil-full.svg`) on warm/white themes and mobile viewports; displays the white sigil (`alice-sigil-full-white.svg`) on the navy theme and in `SceneDeck.js` (slideshow).
