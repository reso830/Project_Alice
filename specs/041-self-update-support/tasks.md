...
- [x] T001 [P] Mount update router in `server/index.js`
...
- [x] T002 Create empty routes skeleton file at `server/routes/update.js`
...
- [x] T003 Create lockfile management helper in `server/portable/lock.js`
...
- [x] T004 Integrate single-instance lock file checks into `server/portable.js`
...
- [x] T004b [US2] Implement `onShutdown` callback in `server/portable.js`
  - **Target**: [server/portable.js](../../server/portable.js)
...
- [x] T005 Update health endpoint to expose app version and updates capability
...
- [x] T006 [P] Create unit tests for SQLite migrations in `tests/unit/migration.test.js`
...
- [x] T007 Create database migration registry in `server/db/migration.js`
...
- [x] T008 Integrate migrations runner and pre-migration backups in `server/db.js`
...
- [x] T009 Move portable database schema creation to the first migration script
...
- [x] T010 [P] [US1] Create unit tests for release parsing and checksum check in `tests/unit/update.test.js`
...
- [x] T010b [US1] Create mock release zip and checksum test fixtures
...
- [x] T011 [US1] Implement version check endpoint `GET /api/update/check` in `server/routes/update.js`
...
- [x] T012 [US1] Implement update download and staging in `server/routes/update.js`
  - **Target**: [server/routes/update.js](../../server/routes/update.js)
...
- [x] T013 [US1] Implement status query endpoint `GET /api/update/status` in `server/routes/update.js`
  - **Target**: [server/routes/update.js](../../server/routes/update.js)
...
- [x] T014 [US1] Implement update restart command route `POST /api/update/restart` in `server/routes/update.js`
  - **Target**: [server/routes/update.js](../../server/routes/update.js)
...
- [x] T015 [US1] Create toast component `src/components/UpdateToast.js`
...
- [x] T016 [US1] Mount `UpdateToast` in global layout `src/main.js`
...
- [x] T017 [US1] Update `src/components/Footer.js` to render mode-aware controls
...
- [x] T017b [US1] Render persistent update notification badge on Navbar and BottomTabBar
...
- [x] T018 [US2] Update launcher script `scripts/portable/Start-Alice.cmd` to perform updates swap
...
- [x] T019 [US2] Verify database rollback restore safety end-to-end by provoking a schema migration error
...
- [x] T020 [US3] Implement settings endpoints `GET /api/update/settings` and `POST /api/update/settings`
  - **Target**: [server/routes/update.js](../../server/routes/update.js)
...
- [x] T022 [US3] Hide the Updates subgroup entirely when updates are unsupported
  - **Target**: [src/pages/Profile.js](../../src/pages/Profile.js)
...
- [x] T023 Accessibility and responsive review
...
- [x] T024 Run project lint and format checks
...
- [x] T025 Bump version in `package.json`
...
- [x] T025b Bump display version in `src/pages/welcome/shared/appMeta.js`
...
- [x] T026 Sync root fields in `package-lock.json`
...
- [x] T031 Verify docs clean references
