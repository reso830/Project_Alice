...
| `tests/services/` | API client, supabase client, resume API, health API, LLM parser (`llmParser.test.js`, 033), AI provider/service abstraction (`aiService.test.js`, `providers/openrouter.test.js`, 038), compat notes service (`compatNotesService.test.js`, 037) |
